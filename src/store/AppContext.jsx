...
const initialState = {
  ...
  gateways: [
    ...
    { name: 'OmegaPay', connected: false, type: 'PIX' },
    { name: 'SigiloPay', connected: false, type: 'PIX' },
    { name: 'Paradise', connected: false, type: 'PIX' },
    { name: 'HooPay', connected: false, type: 'PIX' },
    { name: 'Freepay', connected: false, type: 'PIX' },
    { name: 'AmploPay', connected: false, type: 'PIX / Cartão' },
    { name: 'TriboPay', connected: false, type: 'PIX' },
    { name: 'AtomoPay', connected: false, type: 'PIX' },
    { name: 'IronPay', connected: false, type: 'PIX' },
    { name: 'WiinPay', connected: false, type: 'PIX / Cartão' },
    { name: 'NXGate', connected: false, type: 'PIX / Cartão' },
    { name: 'AxenPay', connected: false, type: 'PIX' },
    { name: 'VeoPag', connected: false, type: 'PIX' },
    { name: 'Mercado Pago PIX', connected: false, type: 'PIX' },
    { name: 'Mercado Pago Cartão', connected: false, type: 'Cartão' },
    { name: 'PixGateIP', connected: false, type: 'PIX' },
    { name: 'Duck', connected: false, type: 'PIX / Cartão' },
    { name: 'Bestfy', connected: false, type: 'PIX' },
